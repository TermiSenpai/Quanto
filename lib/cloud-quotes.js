...
function buildQuoteRows(quote) {
  ...
  const row = {
    ...
    ts: quote.ts,
    user: quote.user,
    client_name: numberOr(quote.client_name, customer.name),
    client_phone: numberOr(quote.client_phone, customer.phone),
    valid_until: quote.valid_until,
    pack_id: quote.pack_id,
    tier: quote.tier,
    total_units: quote.total_units,
    qty_3xl: numberOr(quote.qty_3xl, 0),
    qty_4xl: numberOr(quote.qty_4xl, 0),
    qty_5xl: numberOr(quote.qty_5xl, 0),
    total_vat_inc: quote.total_vat_inc,
    sale_base: quote.sale_base,
    margin_pct: quote.margin_pct,
    target_margin: numberOr(quote.target_margin, null),
    pvp_deviation_pct: numberOr(quote.pvp_deviation_pct, null),
