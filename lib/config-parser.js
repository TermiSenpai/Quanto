// ============================================================
// Quanto · config.js parser and validation
// ============================================================
...
const REQUIRED_SECTIONS = ['parameters', 'products', 'tiers', 'packs', 'admin'];
...
function validateConfigShape(cfg) {
  ...
  if (!cfg.products || typeof cfg.products !== 'object') {
    throw new Error('cfg.products debe ser un objeto');
  }
...
function serializeConfig(config) {
  ...
  return `// ============================================================
// Quanto - Configuración de la calculadora
// ============================================================
