...
// the parts a user wants to judge a template by: a multi-line bundle, a
// per-person price, special-size surcharge, and editable conditions. The
// client name carries markup to prove the engine escapes values (XSS
// guarantee) — never rendered as live HTML. Pure data, no I/O.
const DEMO_QUOTE = {
  id: 'PRE-2026-0042',
  ...
  result: {
    ...
    surcharges: 18,
    extras_no_vat: 0,
    total_vat_inc: 1361.25,
    sale_base: 1125,
    vat: 236.25,
    breakdown: [
      { name: 'Camiseta DTF', sides: 2, quantity: 25, price: 18, subtotal: 450 },
      { name: 'Sudadera DTF', sides: 1, quantity: 25, price: 27, subtotal: 675 }
    ]
  }
};
